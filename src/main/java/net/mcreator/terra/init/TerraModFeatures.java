...
import net.mcreator.terra.world.features.ores.TrolliumOxideFeature;
...
public class TerraModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(TrolliumOxideFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.UNDERGROUND_ORES,
				TrolliumOxideFeature.GENERATE_BIOMES, TrolliumOxideFeature.CONFIGURED_FEATURE));
	}
