...
public class TrollmiteEntity extends Monster {
	public TrollmiteEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(TerraModEntities.TROLLMITE, world);
	}

	public TrollmiteEntity(EntityType<TrollmiteEntity> type, Level world) {
		super(type, world);
		xpReward = 150;
		setNoAi(false);
	...
	public static void init() {
		DungeonHooks.addDungeonMob(TerraModEntities.TROLLMITE, 180);
	}
