package net.mcreator.terra.client.model;
...
public class ModelTrollmite<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("terra", "model_trollmite"), "main");
	public final ModelPart leggers1;
	public final ModelPart leggers2;
	public final ModelPart CHOMPERS;
	public final ModelPart Chomper2;
	public final ModelPart bb_main;

	public ModelTrollmite(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leggers1 = partdefinition.addOrReplaceChild("leggers1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -4.0F, 1.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition leggers2 = partdefinition.addOrReplaceChild("leggers2",
				CubeListBuilder.create().texOffs(0, 0).addBox(4.0F, -4.0F, -2.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition CHOMPERS = partdefinition.addOrReplaceChild("CHOMPERS",
				CubeListBuilder.create().texOffs(0, 0).addBox(1.0F, -3.0F, -3.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition Chomper2 = partdefinition.addOrReplaceChild("Chomper2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -3.0F, -3.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition bb_main = partdefinition
				.addOrReplaceChild(
						"bb_main", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -4.0F, -5.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
								.texOffs(0, 0).addBox(1.0F, -4.0F, -5.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition cube_r1 = bb_main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -4.0F, -4.0F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)),
